...
export const ParticipantsAthleteTab = (props: IPanelTabProps) => {
  ...
  filter.where!.push({ column: 'individualParticipantType', value: 'ATHLETE' });
  ...
  return (
    <DataGridPanel
      ...
      dataSource={{
        url: `${config.apiNode}/search/athletes`,
        apiVersion: 'search',
